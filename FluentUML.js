...
function FluentUML() {
	...
	for (let k in FluentUML_defaults)
		this.conf[k] = FluentUML_defaults[k];
}
(function() {
var cnt = 0;
...
var edgeProperties = str2obj('length direction width note arrow line arrowBack extra type start end tip')
var nodeProperties = str2obj('type form name note width divider')
var diagramTypes = str2obj('class sequence usecase class object activity component deployment state timing');
var associations = {
	'uses' : '>',
	'extends' : '^',
	'belongs': '*',
...
var edgeDirections = str2obj('up down left right');
for (let k in FluentUML_defaults) {
...
FluentUML.prototype.toHTML = function () {
	...
	+ '<pre id=' + id + ' style=display:none;border:solid;padding:10px>' + this.toString().replace(/[\u00A0-\u9999<>\&]/g, function(i) { return '&#'+i.charCodeAt(0)+';'; })
}
